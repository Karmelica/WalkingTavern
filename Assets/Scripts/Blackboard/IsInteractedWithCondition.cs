...
[Serializable]
[GeneratePropertyBag]
[Condition("Is Interacted With", story: "[Dish] [Is] held", category: "Conditions",
	id: "8b91f9686dda684b943a65227f0b2bf8")]
public class IsInteractedWithCondition : Condition
{
	...
	public override bool IsTrue()
	{
		if (Dish.Value.TryGetComponent<MoveableObject>(out var moveableObject)) {
			if (moveableObject.IsInteractedWith() == Is) {
				return true;
			}
		}
