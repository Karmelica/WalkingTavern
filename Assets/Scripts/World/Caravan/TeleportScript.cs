	...
	public class TeleportScript : MonoBehaviour
	{
		...
		private void OnTriggerEnter(Collider other)
		{
			if (other.TryGetComponent(out _traveller)) {
				var m = target.targetTeleportPosition.transform.localToWorldMatrix * transform.worldToLocalMatrix *
				        _traveller.transform.localToWorldMatrix;
