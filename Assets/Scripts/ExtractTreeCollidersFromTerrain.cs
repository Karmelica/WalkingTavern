...
public class ExtractTreeCollidersFromTerrain : MonoBehaviour
{
	...
	private void CreateNavMeshObstacle(TreePrototype tree, int prototypeIndex, TreeInstance[] instances,
		int instanceIndex)
	{
	...
	private GameObject CreateGameObjectForNavMeshObstacle(TreePrototype tree, TreeInstance[] instances,
		int instanceIndex, Vector3 primitiveScale)
	{
