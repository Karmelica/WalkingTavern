...
namespace Managers
{
	public class PlayerSpawner : NetworkBehaviour
	{
		...
		[Scene] [SerializeField] private List<string> scenesToSpawnPlayersIn;
		...
		private void OnSceneLoadStarted(ulong clientId, string currentSceneName, LoadSceneMode loadSceneMode,
