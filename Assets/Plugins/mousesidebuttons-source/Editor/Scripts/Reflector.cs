...
namespace MouseSideButtons
{
    ...
    public class Reflector
    {
        ...
        static Reflector()
        {
            ...
            _methodSetFolderSelection = _typeProjectBrowser.GetMethod("SetFolderSelection", BindingFlags.Instance | BindingFlags.NonPublic, null, new[] { typeof(EntityId[]), typeof(bool) }, null);
#else
        ...
        {
#if UNITY_6000_3_OR_NEWER
            return (EntityId)_methodGetFolderInstanceID.Invoke(null, new object[] { destination });
#else
        ...
        {
#if UNITY_6000_3_OR_NEWER
            _methodSetFolderSelection.Invoke(GetLastBrowserInstance(), new object[] { new EntityId[] { destinationID }, false });
#else
